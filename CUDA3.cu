...
// RNG functions removed to prioritize strict range adherence.
...
// ============================================================
// KERNEL: STRICT LINEAR SCAN (No Randomization)
// ============================================================
...
int main(int argc, char** argv) {
    ...
    // ==========================================
    // MODIFIKASI: STRICT LINEAR INITIALIZATION
    // ==========================================
    std::cout << "Info: Initializing Strict Linear Range...\n";
    
    for (uint64_t i = 0; i < threadsTotal; ++i) {
        // 1. Hitung Base Offset Linear
        // offset_linear = i * per_thread_cnt
        uint64_t offset_linear[4];
        mul256_u64(per_thread_cnt, i, offset_linear);

        // 2. Start Scalar = range_start + offset_linear
    ...
    std::cout << std::left << std::setw(20) << "Mode"              << " : STRICT LINEAR SWEEP\n";
